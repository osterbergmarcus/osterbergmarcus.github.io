...
// reference to firebase JSON tree
  var messagesRef = new Firebase('https://amber-fire-3025.firebaseio.com/');
  ...
  var listRef = new Firebase("https://amber-fire-3025.firebaseio.com/presence/");
  var userRef = listRef.push();

  // Add ourselves to presence list when online
  var presenceRef = new Firebase("https://amber-fire-3025.firebaseio.com/.info/connected");
